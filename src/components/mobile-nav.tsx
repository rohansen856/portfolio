...
import { sidebarLinks } from "@/components/side-nav"
...
export function DockDemo() {
    ...
    React.useEffect(() => {
        const sentinel = document.querySelector("#home-sentinel")
        if (!sentinel) return
    ...
    return (
        <div style={{ height: dockHeight || undefined }} className="w-full block md:hidden">
            <div
                ref={dockRef}
                className={
                    (isSticky ? "fixed top-0 left-0 right-0 z-50" : "relative") +
                    " flex justify-center pointer-events-auto transition-transform duration-200"
                }
            >
